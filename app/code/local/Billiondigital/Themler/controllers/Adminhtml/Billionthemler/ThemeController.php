...
class Billiondigital_Themler_Adminhtml_Billionthemler_ThemeController extends Billiondigital_Themler_Controller_AdminAction
{
    ...
    public function publishAction() {
        ...
        if ($this->getRequest()->isAjax()) {
            ...
            $this->adminRedirect('adminhtml/billiontheme_list/index');
        }
    }
    ...
    public function reloadTemplatesInfoAction()
    {
        $this->setAjaxResponse(array(
            'templates' => Mage::helper('billionthemler/template')->getList($this->currentTheme)
        ));
    }
