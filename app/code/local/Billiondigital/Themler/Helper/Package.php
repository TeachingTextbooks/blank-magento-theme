    ...
    public function unpackPackage($uploadPath)
    {
        ...
        if (count($errors)) {
            ...
            if (version_compare($newCoreVersion, $currentCoreVersion, '>')) {
                $fso->remove(MAGENTO_ROOT . '/app/code/local/Billiondigital/Core');
                $fso->copy(
            ...
            if (version_compare($newThemeVersion, $currentThemeVersion, '>')) {
                $fso->remove(MAGENTO_ROOT . '/app/code/local/Billiondigital/Theme');
                $fso->copy(
            ...
            if ($themlerConfig) {
                ...
                if (version_compare($newThemlerVersion, $currentThemlerVersion, '>')) {
                    $fso->remove(MAGENTO_ROOT . '/app/code/local/Billiondigital/Themler');
                    $fso->copy(
