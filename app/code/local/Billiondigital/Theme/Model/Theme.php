...
class Billiondigital_Theme_Model_Theme extends Varien_Object
{
    public function getSettingsUrl() {
        return $this->getUrl('adminhtml/billiontheme_settings/index');
    }

    public function getPublishUrl() {
        return $this->getUrl('adminhtml/billionthemler_theme/publish');
    }
    ...
    public function getEditUrl() {
        ...
        $url = Mage::helper('core/url')->addRequestParam(
            Mage::getUrl('adminhtml/billionthemler_theme/index'),
            $params
        );
