...
Checkout.prototype = {
    initialize: function(accordion, urls){
        ...
        this.accordion.sections.each(function(section) {
            Event.observe($(section), 'click', this._onSectionClick.bindAsEventListener(this));
        }.bind(this));

        jQuery('.bd-checkoutsteps-1').on('click', 'a.section', jQuery.proxy(this._onMenuSectionClick, this));
    ...
    _onMenuSectionClick: function(event) {
        event.stopPropagation();
        var section = jQuery(event.currentTarget);
        if (section.hasClass('allow')) {
            this.gotoSection(section.attr('id').replace('opc-menu-', ''));
        }
        return false;
    },
    ...
    gotoSection: function(section)
    {
        ...
        var menuElement = $('opc-menu-' + section);
        menuElement.addClassName('allow');
        menuElement.addClassName('active');
    ...
    setBilling: function() {
        if (($('billing:use_for_shipping_yes')) && ($('billing:use_for_shipping_yes').checked)) {
            ...
            var opcMenu = $('opc-menu-shipping');
            opcMenu.addClassName('allow');
            opcMenu.addClassName('active');
